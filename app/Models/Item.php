...
class Item extends Model implements HasMedia
{
    ...
    public function scopeCuisineType($query, $cuisineType)
    {
    ...
    public function isParcelCategory(): bool
    {
        return $this->item_category_id == config('constants.parcel_category_id');
    }
