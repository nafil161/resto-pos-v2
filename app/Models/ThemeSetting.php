...
class ThemeSetting extends Model implements HasMedia
{
    ...
    public function getPrintLogoAttribute(): string
    {
        if (!empty($this->getFirstMediaUrl('theme-print-logo'))) {
            return asset($this->getFirstMediaUrl('theme-print-logo'));
        }
        return asset('images/theme/theme-print-logo.png');
    }
}
